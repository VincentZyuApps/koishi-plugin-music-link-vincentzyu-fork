...
Project: `koishi-plugin-music-link-vincentzyu-fork`

This project is licensed under the MIT License. See [LICENSE](./LICENSE) for the
full license text.

## Font Usage Declaration

This plugin uses the following open-source fonts for image rendering:
...
- Description: An open-source Pan-CJK font developed by Adobe and Google
...
- License: `SIL Open Font License 1.1`
- Copyright: LXGW
- Description: Derived from FONTWORKS' Klee One font
...
- Description: Google's color emoji font

All fonts above are licensed under `SIL Open Font License 1.1` and can be used,
modified, and distributed in this project under their respective terms.
...
- 版权所有：Adobe Systems Incorporated
- 说明：由 Adobe 与 Google 联合开发的开源泛中日韩字体
...
- 许可证：`SIL Open Font License 1.1`
- 版权所有：LXGW（落霞孤鹜）
- 说明：基于 FONTWORKS 出品的 Klee One 字体衍生
...
- 许可证：`SIL Open Font License 1.1`
- 版权所有：Google Inc.
- 说明：Google 开发的彩色 Emoji 字体

以上字体均遵循 `SIL Open Font License 1.1` 开源协议，可在本项目中按各自
许可证条款使用、修改与发布。感谢所有开源字体项目的贡献者。
