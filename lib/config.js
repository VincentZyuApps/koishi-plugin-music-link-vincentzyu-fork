...
const Config = Schema.intersect([
   ...
   Schema.union([
      ...
      Schema.object({
         ...
         command6_add_music_card: Schema.boolean().default(true).description("🎵 是否发送onebot音乐卡片，位于所有的字段的最后 <br/> *仅适用于 `onebot` 和 `red` 平台，其他平台开启无效*"),
   ...
   Schema.object({
      ...
      data_Field_Mode: Schema.union([
         ...
         Schema.const('image').description('富媒体置底但是图片置顶：图片 > 文字 ≥ 语音 ≥ 视频 ≥ 文件 （仅官方机器人考虑使用）'),
