...
const Config = Schema.intersect([
   ...
   Schema.object({
      ...
      svgWidth: Schema.number().default(555).min(300).max(800).step(1).description('📐 SVG 图片宽度（px）'),
      svgColumns: Schema.number().default(2).min(1).max(4).description('📊 SVG 歌单列数'),
      svgShowRenderInfo: Schema.boolean().default(true).description('📊 是否在 SVG 图片后显示渲染耗时等统计信息'),
   ...
   Schema.object({
      ...
      puppeteerShowRenderInfo: Schema.boolean().default(true).description('📊 是否在 Puppeteer 图片后显示渲染耗时等统计信息'),
