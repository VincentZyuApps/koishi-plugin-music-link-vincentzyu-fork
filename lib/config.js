...
const { getDefaultAssetDisplayPath } = require('./utils');
...
const Config = Schema.intersect([
    ...
    Schema.union([
        ...
        Schema.object({
            ...
            command6_AddQqRichuiCard: Schema.boolean().experimental().default(false).description("🎴 是否在歌曲字段前发送 QQ RichUI 音乐卡片<br/>⚠️ *仅适用于 QQ 官方机器人平台，依赖客户端 RichUI 能力*"),
        ...
        Schema.object({
            ...
            command9_AddQqRichuiCard: Schema.boolean().experimental().default(false).description("🎴 是否在歌曲字段前发送 QQ RichUI 音乐卡片<br/>⚠️ *仅适用于 QQ 官方机器人平台，依赖客户端 RichUI 能力*"),
