...
const Config = Schema.intersect([
   ...
   Schema.object({
      ...
      markdownShowRenderInfo: Schema.boolean().default(true).description('📊 是否在 QQ Markdown 消息末尾增加引用块显示版本、时间等信息<br>格式：<code>> generated by...</code><br>> version...<br>> date_time...<br>> repo_url...'),
