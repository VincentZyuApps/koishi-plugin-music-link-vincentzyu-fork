...
function renderSongListSvg(songs, options = {}) {
  ...
  return {
    ...
    renderInfo: `\b(🚀 resvg 渲染耗时：${elapsed}ms | 缩放：${scale}x\n\n)`,
  };
}
