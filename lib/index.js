               ...
               if (isSongId && !options.number) {
                  ...
                  try {
                     ...
                     if (!selectedSong.url) {
                        ...
                        logInfo("========== API返回的原始数据 ==========");
                        logInfo("detailResponse.code:", detailResponse.code);
                        logInfo("detailResponse.data:", JSON.stringify(detailResponse.data, null, 2));
                        logInfo("detailResponse.data.pay:", detailResponse.data?.pay);
                        logInfo("========================================");
                     ...
                     logInfo("========== 处理后的歌曲数据 ==========");
                     logInfo("processedSongData.pay:", processedSongData.pay);
                     logInfo("finalSongData.pay:", finalSongData.pay);
                     logInfo("processedSongData (不含歌词):", JSON.stringify({...processedSongData, lrc: '(歌词省略)'}, null, 2));
                     logInfo("========================================");
