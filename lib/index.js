...
const { validateAssets, normalizeAssetConfigPaths, createUtilFunctions, safeUnlink, safeJsonParse, buildSongUrl } = require('./utils');
...
const { sendQqRichuiCard } = require('./qq/qq-richui');
